...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERITEMS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORDERITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORDERITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORDERITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORDERITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORDERITEMS actions', async () => {
      const expectedActions = [
        {
