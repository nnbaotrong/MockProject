...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_TYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TYPE actions', async () => {
      const expectedActions = [
        {
