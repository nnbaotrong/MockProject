    ...
    <Row>
      <Col md="8">
        <h2 data-cy="authorDetailsHeading">
          <Translate contentKey="mockProjectApp.author.detail.title">Author</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="firstName">
              <Translate contentKey="mockProjectApp.author.firstName">First Name</Translate>
            </span>
          </dt>
          <dd>{authorEntity.firstName}</dd>
          <dt>
            <span id="lastName">
              <Translate contentKey="mockProjectApp.author.lastName">Last Name</Translate>
            </span>
          </dt>
