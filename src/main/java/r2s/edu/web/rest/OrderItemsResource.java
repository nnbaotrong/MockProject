...
/**
 * REST controller for managing {@link r2s.edu.domain.OrderItems}.
 */
@RestController
@RequestMapping("/api")
public class OrderItemsResource {
    ...
    public ResponseEntity<List<OrderItemsDTO>> getAllOrderItems(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
