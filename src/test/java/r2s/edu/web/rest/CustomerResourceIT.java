...
class CustomerResourceIT {
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getInformation()).isEqualTo(DEFAULT_INFORMATION);
    ...
    void putNewCustomer() throws Exception {
        ...
        assertThat(testCustomer.getInformation()).isEqualTo(UPDATED_INFORMATION);
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.firstName(UPDATED_FIRST_NAME).address(UPDATED_ADDRESS).password(UPDATED_PASSWORD);
