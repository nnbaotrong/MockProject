...
import static r2s.edu.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import r2s.edu.domain.User;
import r2s.edu.repository.AuthorityRepository;
import r2s.edu.repository.UserRepository;
import r2s.edu.security.AuthoritiesConstants;
import r2s.edu.service.UserService;
import r2s.edu.service.dto.AdminUserDTO;
import r2s.edu.service.dto.PasswordChangeDTO;
import r2s.edu.service.dto.UserDTO;
import r2s.edu.web.rest.vm.KeyAndPasswordVM;
import r2s.edu.web.rest.vm.ManagedUserVM;
